...
class TopListenLogSongViewModel extends ChangeNotifier implements ISongLogViewModel {
  ...
  @override
  List<int> get getLogSongsId => _songLogService.getTopListenSongsId;
  ...
  Future<void> initialize() async {
    ...
    try {
      final List<int> songsId = await _songLogService.getTopListenSongsIdWithLimit(limit: 30);      
