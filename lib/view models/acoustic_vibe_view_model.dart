...
class AcousticVibeViewModel extends ChangeNotifier implements IVibeViewModel  {  
  ...
  late final String _playlistId = Playlistid.acoustic;
  ...
  String generateLabel() => _labelingService.generate(LabelType.acoustic);
  ...
  Future<void> updateSong(int songId, Song song) async {
    ...
    try {
      ...
      if (song.vibe == Vibe.acoustic) return;
  ...
  Future<void> initialize() async {
    ...
    try {
      _songsId = await _songService.getSongsId(vibe: Vibe.acoustic);
