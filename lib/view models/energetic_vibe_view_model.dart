...
class EnergeticVibeViewModel extends ChangeNotifier implements IVibeViewModel  {  
  ...
  late final String _playlistId = Playlistid.energetic;
  ...
  String generateLabel() => _labelingService.generate(LabelType.energetic);
  ...
  Future<void> updateSong(int songId, Song song) async {
    ...
    try {
      ...
      if (song.vibe == Vibe.energetic) return;
  ...
  Future<void> initialize() async {
    ...
    try {
      _songsId = await _songService.getSongsId(vibe: Vibe.energetic);
