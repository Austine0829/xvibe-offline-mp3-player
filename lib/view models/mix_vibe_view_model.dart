...
class MixVibeViewModel extends ChangeNotifier implements IVibeViewModel  {  
  ...
  late final String _playlistId = Playlistid.mix;
  ...
  Future<void> initialize() async {
    ...
    try {
      _songsId = await _songService.getRandomSongsIdWithLimit(limit: 50);
