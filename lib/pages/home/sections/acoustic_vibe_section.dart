...
class AcousticVibeSection extends StatefulWidget {
  const AcousticVibeSection({super.key});

  @override
  State<AcousticVibeSection> createState() => _AcousticVibeSectionState();
}

class _AcousticVibeSectionState extends State<AcousticVibeSection> {
  late final String _label;

  @override
  void initState() {
    super.initState();
    final viewModel = context.read<AcousticVibeViewModel>();
            ...
            children: [
                  ...
                  Navigator.push(
                    ...
                    MaterialPageRoute(
                      builder: (_) => ShowMorePage(
                        vibeViewModel: (context) => context.watch<AcousticVibeViewModel>()
                      ),
                    ),
                  );
                },
              ...
              Container(
                ...
                child: ListView.separated(
                  ...
                  itemCount: acousticVibeViewModel.getSongsId.length >= 10 ? 10 : acousticVibeViewModel.getSongsId.length,
                ),
              ),
            ],
          )
